<template>
  <div class="page-container">
    <div class="page-header">
      <span class="page-title">退住申请</span>
      ...
      <el-table :data="tableData" v-loading="loading" border stripe>
        ...
        <el-table-column label="操作" width="250" fixed="right">
          <template #default="scope">
            ...
            <el-button v-if="scope.row.status === 0" type="success" link @click="handleEdit(scope.row)">编辑</el-button>
...
const tableData = ref([
  { id: 1, elder_name: '张阿姨', contract_no: 'HT202312003', checkout_date: '2024-05-10', reason: '子女接回家照顾', refund_amount: 5000, status: 0 },
  { id: 2, elder_name: '刘叔叔', contract_no: 'HT202401005', checkout_date: '2024-04-20', reason: '身体原因需要专业医院治疗', refund_amount: 8000, status: 1 }
])
